...
class _GoogleMapPageState extends State<GoogleMapPage> {
  ...
  initState() {
    ...
    staticMapUri = staticMapProvider.getStaticUri(Locations.portland, 14,
        width: 900, height: 400, mapType: StaticMapViewType.roadmap);
  }

  @override
  Widget build(BuildContext context) {
    return new SizedBox(child: showMap(),width: 100,height: 100,);
  }
    ...
    mapView.show(
        new MapOptions(
            ...
            initialCameraPosition: new CameraPosition(
                new Location(40.3716222, 49.8555191), 11.0),
            hideToolbar: false,
